  ...
  return (
    ...
    <form onSubmit={onSubmitIncome}>
        ...
        <div className="input-group expense">
            <input type="text" value ={expenseText} placeholder="Add income..." name="expenseText" autoComplete="off"onChange={onChangeExpense} />
            <input type="number" value ={expenseAmount} placeholder="Amount" name ="expenseAmount" autoComplete="off"onChange={onChangeExpense} />
            <input type="submit" value="submit"/>
        </div>
        </form> 
    </div>
